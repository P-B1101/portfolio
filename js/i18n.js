...
(() => {
  ...
  const FA = {
    ...
    'cv.pro.href': 'cv/pdf/pedram-cv-professional-fa.pdf?v=2.0.3',
    'cv.fancy.href': 'cv/pdf/pedram-cv-designed-fa.pdf?v=2.0.3',
    ...
    'c2.h2': 'اردیبهشت: پایان دانشگاه.<br>تیر: اولین تجربه کاری.',
    ...
    'yf': '۱۴۰۴',
    'cf.ghost': '۱۴۰۴',
    'cf.kicker': 'فصل ۰۹ · در کنار کار اصلی',
    'cf.h2': 'فریلنس، در کنار کار اصلی.',
    'cf.p': 'در کنار کار اصلی، برای مشتری‌ها اپلیکیشن می‌سازم: Stolz برای پایش موتور آسانسور (۱۴۰۳)، نسخه آفلاین iClassifier با ویدئوی زنده روی شبکه محلی (۱۴۰۳)، و Vehicle Tracker برای ردیابی زنده خودرو و قفل درها از راه دور (۱۴۰۴).',
    'cf.tags': '<li>Stolz</li><li>iClassifier</li><li>Vehicle Tracker</li>',
