...
(() => {
  ...
  const FA = {
    ...
    'description': 'پدرام محمدعلی‌پور، توسعه‌دهنده فلاتر. داستان مسیر من، از ۱۳۹۱ تا امروز.',
    'top': 'بازگشت به ابتدا',
    ...
    'c2.p': 'به‌عنوان توسعه‌دهنده اندروید به پاراتک پیوستم و کارم را با جاوا شروع کردم. نزدیک به پنج سال آنجا ماندم؛ مسیری که در ادامه، فلاتر را هم به کارم اضافه کرد.',
    ...
    'c7.p': 'فروردین، روی سامانه حساب وکالتی بانک شهر کار کردم. چند ماه بعد، در مرداد، به‌عنوان توسعه‌دهنده فلاتر به هلدینگ نگاه پیوستم.',
    ...
    'c8.h2': 'داتین.',
    'c8.p': 'اردیبهشت ۱۴۰۳ به‌عنوان توسعه‌دهنده فلاتر به داتین پیوستم؛ جایی که مسیرم تا امروز در آن ادامه دارد.',
